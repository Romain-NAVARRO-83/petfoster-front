const AboutUs = () => {
  return (
    <>
      <div><h1 className="title">Qui sommes-nous</h1></div>
      ...
      {/* Nos engagements */}
      <section className="section px-5"> {/* Ajout de padding pour espacer le texte */}
        <div className="container">
      ...
      {/* Foire aux questions */}
      <section className="yellow-line px-5"> {/* Ajout de padding pour espacer le texte */}
        <div className="container">

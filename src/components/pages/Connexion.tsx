...
const RegistrationPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showSuccessToast('Votre compte a bien été créé ! Vous pouvez maintenant vous connecter');
            setActiveTab('login');
        } catch (error) {
    ...
    const fetchcitys = async (zip: string) => {
        try {
            ...
            const citys = response.data.places.map((place: any) => place['place name']);
    ...
    const handleCityChange = async (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (selectedCity && country) {
            try {
                const response = await axios.get(`https://nominatim.openstreetmap.org/search?city=${selectedCity}&country=${country}&format=json`);
                ...
                <div className="box">
                    {activeTab === 'login' ? (
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            {/* Nom */}
                            <div className="field">
                                <label className="label">Nom <span className="has-text-danger">*</span></label>
                                <div className="control">
                                    <input
                                        className="input"
                                        type="text"
                                    ...
                                    />
                                                        ...
                                                        {/* Mot de passe */}
                                                        <div className="field">
                                <label className="label">Mot de passe <span className="has-text-danger">*</span></label>
                                <div className="control">
                                    <input
                                        className="input"
                                        type="password"
                            ...
                            <div className="field">
                                <label className="label">Confirmer le mot de passe <span className="has-text-danger">*</span></label>
                                <div className="control">
                                    <input
                                        className="input"
                                        type="password"
                            ...
                            {/* Pays */}
                            <div className="field">
                                <label className="label">Pays <span className="has-text-danger">*</span></label>
                                <div className="control">
                            ...
                            {/* Code postal */}
                            <div className="field">
                                <label className="label">Code postal <span className="has-text-danger">*</span></label>
                                <div className="control">
                                    <input
                                        className="input"
                                        type="number"
                            ...
                            {/* Ville */}
                            <div className="field">
                                <label className="label">Ville <span className="has-text-danger">*</span></label>
                                <div className="control">
                                    <div className="select">
